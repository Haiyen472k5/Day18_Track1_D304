...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | -------- |
| Solution mechanism                                                                                                                                                | Nút ghi chú/Tooltip thông minh gắn trực tiếp vào các khái niệm khó, thuật ngữ hoặc sơ đồ ngay trên slide bài giảng.                                              |          |          |
| User làm gì?                                                                                                                                                    | Click hoặc rê chuột (Hover) vào biểu tượng`[?]` / nút ghi chú tại từ khó trên slide để đọc giải thích và ví dụ trong 5–10 giây.                            |          |          |
| AI làm gì?                                                                                                                                                      | Phân tích slide bài giảng trước buổi học để tự động phát hiện khái niệm khó, tạo tóm tắt định nghĩa ngắn gọn (< 3 dòng) và ví dụ trực quan dễ hiểu. |          |          |
| Trigger                                                                                                                                                           | Khi người học nhìn thấy icon ghi chú cạnh khái niệm/sơ đồ chưa hiểu trên slide và chủ động bấm xem.                                                              |          |          |
| Trade-off chính                                                                                                                                                  | **Ưu điểm:** Cực nhanh, không mất mạch học, không cần gõ.                                                                                                           |          |          |
| **Hạn chế:** Chỉ giải thích được các khái niệm đã chuẩn bị sẵn trên slide, không trả lời được các thắc mắc phát sinh ngoài lề. |                                                                                                                                                                                      |          |          |
