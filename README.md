...
> Nguồn: https://codelabs.vlearn.dev/codelab/track-1-day-18-multiple-prototypes-human-ai-design  
> Nội dung được thu thập từ trang bài học và chuẩn hóa thành Markdown vào ngày 2026-08-18.

## Mục lục

1. [Đề bài và cách làm](#1-đề-bài-và-cách-làm)
2. [Đầu vào từ Day 17](#2-đầu-vào-từ-day-17)
3. [Chặng 1 — Tổng hợp evidence](#3-chặng-1--tổng-hợp-evidence--15-phút)
4. [Chặng 2 — Chọn ba Solution Options](#4-chặng-2--chọn-ba-solution-options--20-phút)
5. [Chặng 3 — Human–AI Design pass](#5-chặng-3--humanai-design-pass--30-phút)
6. [Chặng 4 — Build ba micro-prototype](#6-chặng-4--build-ba-micro-prototype--80-phút)
7. [Chặng 5 — Chuẩn bị test](#7-chặng-5--chuẩn-bị-test--15-phút)
8. [Chặng 6 — Test với ba người](#8-chặng-6--test-với-ba-người--20-phút-cuối-hoặc-ngoài-giờ)
9. [Sau lớp — hoàn tất test nếu cần](#9-sau-lớp--hoàn-tất-test-nếu-cần)
10. [Quy tắc dùng AI](#10-quy-tắc-dùng-ai)
11. [Nộp bài](#11-nộp-bài)
...
Luồng kiến thức của Lab:

    Day 17 Evidence → Hypothesis Problem → Three Solution Options
    → Human–AI Design → Three Micro-prototypes → Three A/B/C Tests
    → One Next Change

### Buổi Lab diễn ra như thế nào?

| Thời gian | Người phụ trách | Hoạt động | Mô tả |
|---|---|---|---|
...
- **Giữ một Hypothesis Problem.** A/B/C phải cùng giải một problem cho cùng user và situation.
- **Build ba solution, không phải ba phiên bản giao diện.** Khác màu, wording hoặc layout chưa tạo thành ba option.
- **Mỗi option phải thể hiện một Human–AI interaction.** Nhóm phải nói rõ user làm gì, AI làm gì và ai giữ quyền quyết định.
- **Prototype vừa đủ để test.** Mỗi option chỉ cần 2–3 trạng thái quanh một critical interaction; không build full product.
- **Mỗi tester trải nghiệm cả ba.** Mỗi thành viên test với một người khác, nhưng không được chỉ mang option mình làm đi test.
- **Ghi hành vi trước, diễn giải sau.** “Tester chọn B” chưa đủ nếu không có lý do, trade-off và hành vi đi kèm.
- **Không tuyên bố validated.** Ba feedback tạo input cho iteration tiếp theo, không chứng minh product value hoặc market demand.
...
2. Ba Practice Notes, thường là một note từ mỗi thành viên.
3. Solution Parking Lot có tối thiểu năm hướng.
4. Conversation Guide cuối để tham khảo context; Day 18 không tiếp tục problem interview.
...
_Trạng thái bài nộp trên trang: Đang tải trạng thái bài nộp…_
